    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          <form name="noSentMessage" id="loginForm">
            ...
            <br>
            <div id="loginSuccess" class="text-center">
              <div class="">
                <button type="submit" class="btn btn-secondary btn-xl" id="loginToPage">Login</button>
                <button type="submit" class="btn btn-secondary btn-xl" onclick="location.href='sign_up.php'">Sign up</button>
              </div>
            </div>
          </form>
        </div>
